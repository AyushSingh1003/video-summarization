...
# Example Usage
video_path = r'/Users/ayush/Downloads/video_summarization_Updated/data/test_video.mp4'
save_folder = 'Frames_data'
interval = 30

try:
    saved_frames = extract_and_save_frames(video_path, save_folder, interval)
    print(f"Frames saved to: {save_folder}")
    preprocessed_frames = preprocess_frames(saved_frames)
